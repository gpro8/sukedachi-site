...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  {
    q: "完了した旗はどこで見る？",
    a: "一覧上部の「全て / 募集中 / 完了」で切り替えられます。既定は全て：募集中（締切が近い順→新しい順）のあと完了（新しい順→古い順）。募集中タブだけ並びを選べます。完了は新しいものが先頭です。",
  },
  {
    q: "加勢・義援でウォレットが2回開くのは？",
    a: "JPYCの承認と送信は別の署名です。ボタンは1つ（JPYCで義援する／加勢する）で、承認のあと続けて送信します。すでに承認済みなら1回です。無限承認はしません。",
  },
  {
    q: "加勢（コントリビューション）履歴は？",
